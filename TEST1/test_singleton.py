...
assert data_instance_1 is data_instance_2  # Verificar que son la misma instancia

log_instance_1 = CorporateLog()
log_instance_2 = CorporateLog()
assert log_instance_1 is log_instance_2  # Verificar que son la misma instancia
